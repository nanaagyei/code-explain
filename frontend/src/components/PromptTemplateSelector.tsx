...
export const PromptTemplateSelector: React.FC<PromptTemplateSelectorProps> = ({
  ...
  const categories = [
    ...
    { id: 'technical', name: 'Technical Deep-Dive', icon: '🔬' },
    { id: 'api', name: 'API Documentation', icon: '📚' },
    { id: 'tutorial', name: 'Tutorial Style', icon: '📖' }
  ];
  ...
  if (error) {
    return (
      <div className="text-center py-8">
        <div className="text-danger-500 mb-2">⚠️</div>
  ...
  return (
    <div className="space-y-4">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              {template.language_preference && (
                <span className="px-2 py-1 bg-charcoal-100 text-charcoal-700 text-xs rounded-full">
                  {template.language_preference}
                </span>
              )}
            </div>
      ...
      {templates?.length === 0 && (
        <div className="text-center py-8">
          <div className="text-charcoal-400 mb-2">📋</div>
